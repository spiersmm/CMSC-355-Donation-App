...
public class DonorDeleteItemFromHistoricRecord {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void donorDeleteItemFromHistoricRecord() {
        ...
        ViewInteraction cardView = onView(
                allOf(childAtPosition(
                        allOf(withId(R.id.recycler_view_past),
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.title), withText("Delete Item"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
