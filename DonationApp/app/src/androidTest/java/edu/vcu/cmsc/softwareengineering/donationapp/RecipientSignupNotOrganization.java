...
public class RecipientSignupNotOrganization {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void recipientSignupNotOrganization() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextRecipientEmail),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("caadzima@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.recipientPhone),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("111-222-3333"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editTextRecipientNumber),
                        childAtPosition(
                                ...
                                11),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("1235"), closeSoftKeyboard());
