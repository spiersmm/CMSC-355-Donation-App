...
public class DonorGoodSignupTest {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void donorGoodSignupTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextDonorDOB),
                        childAtPosition(
                                ...
                                7),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("01/10/1990"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editTextDonorPasswordSignup),
                        childAtPosition(
                                ...
                                10),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("abc12345"), closeSoftKeyboard());
