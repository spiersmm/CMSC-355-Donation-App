...
public class DonorGoodForgotPassword {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void donorGoodForgotPassword() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTextDonorUsernameLogin),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("caadzima@gmail.c"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextDonorUsernameLogin), withText("caadzima@gmail.c"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.buttonDonorForgotPassword), withText("Forgot My Password"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout),
                                        childAtPosition(
                                                withId(android.R.id.content),
