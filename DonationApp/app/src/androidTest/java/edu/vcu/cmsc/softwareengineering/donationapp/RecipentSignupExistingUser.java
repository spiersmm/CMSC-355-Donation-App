...
public class RecipentSignupExistingUser {

    @Rule
    public ActivityTestRule<Login> mActivityTestRule = new ActivityTestRule<>(Login.class);

    @Test
    public void recipentSignupExistingUser() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextRecipientEmail),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("adzimaca@vcu.org"), closeSoftKeyboard());
